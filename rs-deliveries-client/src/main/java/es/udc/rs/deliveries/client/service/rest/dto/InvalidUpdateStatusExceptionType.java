...
/**
 * <p>Clase Java para invalidUpdateStatusExceptionType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>{@code
 * <complexType name="invalidUpdateStatusExceptionType">
 *   <complexContent>
...
@XmlType(name = "invalidUpdateStatusExceptionType", propOrder = {
    "shipmentId"
})
public class InvalidUpdateStatusExceptionType {
